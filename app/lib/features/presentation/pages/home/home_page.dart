...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadCounts() async {
    if (globalTicket.isNotEmpty) {
      ...
      int unresolved = globalTicket.where((ticket) => ticket.status == Types.CLAIM.name).length;
      int pending = globalTicket.where((ticket) => ticket.status == Types.SUGGESTION.name).length;
      int resolved = globalTicket.where((ticket) => ticket.status == Types.INFORMATION.name).length;
      setState(() {
